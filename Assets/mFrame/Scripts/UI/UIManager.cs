...
namespace mFrame.UI
{
    ...
    public class UIManager : SingletonMonoBehaviour<UIManager>
    {
            ...
            bool isShowBlackBG = false)
        {
            ...
            {
                LoadResourceTask task = AssetsManager.Instance.AddAssetTask(panelName, OnUIBundleLoaded);
                if (task != null)
                {
        ...
        {
            Vector3 scrnPos = Camera.main.WorldToScreenPoint(worldPos);
        ...
        public void OnEnterLoading()
        {
            ...
            AssetsManager.Instance.ClearUnusedBundles();
        }

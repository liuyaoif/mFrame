...
namespace excel2json
{
    partial class Program
    {
        ...
        private sealed class Options
        {
            ...
            [Option('v', "java", Required = false, HelpText = "指定输出的java数据定义代码文件路径.")]
            ...
            [Option('g', "javaPackage", Required = false, HelpText = "指定Java的Package.")]
            ...
            [Option('i', "javaImport", Required = false, HelpText = "指定Java的import.")]

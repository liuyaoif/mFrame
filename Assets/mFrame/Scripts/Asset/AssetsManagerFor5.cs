...
namespace Utility
{
    public sealed class AssetsManagerFor5 : SingletonMonoBehaviour<AssetsManagerFor5>
    {
        ...
        private void LoadAssetConfig()
        {
            ...
            LoadResourceTask task = new LoadResourceTask(AssetsManagerFor5.Instance.rootBundleURL + "assetconfig.text",
